...
if _G.Mode == "Tiếng Việt" then
    Main:AddDropdown("Chọn Chế Độ Farm",{"Cày Cấp","Cày Cấp Không Nhiệm Vụ","Chọn Bãi Quái Gần Nhất"},function(value)
        _G.Select_Mode_Farm = value
    )
elseif _G.Mode == "English" then
    Main:AddDropdown("Select Mode Farm",{"Level Farm","No Quest","Near Farm Mode"},function(value)
        _G.Select_Mode_Farm = value
    end)
end
